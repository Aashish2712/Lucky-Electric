    ...
    <div class="product-section">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="cart.html">
                        <img src="images/j1.jpg" class="img-fluid product-thumbnail">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="cart.html">
                        <img src="images/j2.jpg" class="img-fluid product-thumbnail">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="cart.html">
                        <img src="images/j3.jpg" class="img-fluid product-thumbnail">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    <h2 class="mb-4 section-title">modular range</h2>
                    <p class="mb-4">With AIR Modular, we’ve just added a new feather to our hat. And this story is
                        one
                        of meticulous craftsmanship, careful detailing, unmatched excellence, beauty and finesse.
                        The
                        modular shape of AIR
                        products are minimalistic, flat and yet distinctive in appearance. </p>
                    <p><a href="shop.html" class="mbtn">Explore</a></p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                    <h2 class="mb-4 section-title">modular range</h2>
                    <p class="mb-4">With AIR Modular, we’ve just added a new feather to our hat. And this story
                        is one
                        of meticulous craftsmanship, careful detailing, unmatched excellence, beauty and
                        finesse. The
                        modular shape of AIR
                        products are minimalistic, flat and yet distinctive in appearance. </p>
                    <p><a href="shop.html" class="mbtn">Explore</a></p>
