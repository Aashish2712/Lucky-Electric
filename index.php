    ...
    <div class="product-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="cart.html">
                        <img src="images/j5.jpg" class="img-fluid product-thumbnail">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="cart.html">
                        <img src="images/j6.jpg" class="img-fluid product-thumbnail">
                        <h3 class="product-title">wire</h3>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="cart.html">
                        <img src="https://source.unsplash.com/500x400/?new television"
